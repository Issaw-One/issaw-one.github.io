const sitesData = {
    films: [
        ...
        },
        {
            ...
            headerBg: 'linear-gradient(135deg,rgb(113, 63, 204) 0%,rgb(173, 147, 250) 100%)',
            description: 'senpai-stream.world <i class="fa-solid fa-check" style="color: #63E6BE;"></i><br><s>senpai-stream.art</s> <i class="fa-solid fa-x" style="color: #ff0000;"></i>',
            tags: ['Update : 02/06/2025'],
            url: 'https://senpai-stream.world/',
            searchUrl: 'https://senpai-stream.world/search/{query}',
            featured: true,
            isNew: true,
            category: 'films'
        },
    ...
    series: [
        ...
        },
        {
            id: 'papadustream',
            name: 'PapaDuStream',
            logo: 'logoSites/PapaDuStream.png',
            headerBg: 'linear-gradient(135deg,rgb(113, 63, 204) 0%,rgb(173, 147, 250) 100%)',
        ...
        },
        {
            id: 'frenchstream',
            name: 'French-Stream',
            logo: 'logoSites/FrechStream.png',
            headerBg: 'linear-gradient(135deg,rgb(113, 63, 204) 0%,rgb(173, 147, 250) 100%)',
            description: 'fsmirror84.lol <i class="fa-solid fa-check" style="color: #63E6BE;"></i><br><s>fsmirror87.lol</s> <i class="fa-solid fa-x" style="color: #ff0000;"></i>',
            tags: ['Update : 03/06/2025'],
            url: 'https://fsmirror84.lol/',
            searchUrl: 'https://fsmirror84.lol/index.php?story={query}&do=search&subaction=search',
            featured: true,
            isNew: false,
            category: 'series'
        },
        ...
        },
        {
            ...
            headerBg: 'linear-gradient(135deg,rgb(113, 63, 204) 0%,rgb(173, 147, 250) 100%)',
            description: 'frembed.space <i class="fa-solid fa-check" style="color: #63E6BE;"></i><br><s>frembed.site</s> <i class="fa-solid fa-x" style="color: #ff0000;"></i>',
            tags: ['Update : 03/06/2025'],
            url: 'https://frembed.space/',
            searchUrl: '',
            featured: true,
            isNew: true,
            category: 'series'
    ...
    dll: [
        ...
        },
        {
            ...
            headerBg: 'linear-gradient(135deg,rgb(113, 63, 204) 0%,rgb(173, 147, 250) 100%)',
            description: 'wawacity.futbol <i class="fa-solid fa-check" style="color: #63E6BE;"></i><br><s>wawacity.pictures</s> <i class="fa-solid fa-x" style="color: #ff0000;"></i>',
            tags: ['Update : 03/06/2025'],
            url: 'https://www.wawacity.futbol/',
            searchUrl: 'https://www.wawacity.futbol/?search={query}&p=films',
            featured: true,
            isNew: false,
            category: 'dll'
        },
        {
            ...
            headerBg: 'linear-gradient(135deg,rgb(113, 63, 204) 0%,rgb(173, 147, 250) 100%)',
            description: 'zone-telechargement.futbol <i class="fa-solid fa-check" style="color: #63E6BE;"></i><br><s>zone-telechargement.picture</s> <i class="fa-solid fa-x" style="color: #ff0000;"></i>',
            tags: ['Update : 03/06/2025'],
            url: 'https://www.zone-telechargement.futbol/',
            searchUrl: 'https://www.zone-telechargement.futbol/?p=films&search={query}',
            featured: true,
            isNew: true,
            category: 'dll'
        },
        {
            ...
            headerBg: 'linear-gradient(135deg,rgb(113, 63, 204) 0%,rgb(173, 147, 250) 100%)',
            description: 'extreme-down.futbol <i class="fa-solid fa-check" style="color: #63E6BE;"></i><br><s>extreme-down.pictures</s> <i class="fa-solid fa-x" style="color: #ff0000;"></i>',
            tags: ['Update : 03/06/2025'],
            url: 'https://www.extreme-down.futbol/',
            searchUrl: 'https://www.extreme-down.futbol/?p=films&search={query}',
            featured: true,
            isNew: true,
            category: 'dll'
        },
        {
            ...
            headerBg: 'linear-gradient(135deg,rgb(113, 63, 204) 0%,rgb(173, 147, 250) 100%)',
            description: 'tirexo.futbol <i class="fa-solid fa-check" style="color: #63E6BE;"></i><br><s>tirexo.pictures</s> <i class="fa-solid fa-x" style="color: #ff0000;"></i>',
            tags: ['Update : 03/06/2025'],
            url: 'https://www.tirexo.futbol/',
            searchUrl: 'https://www.tirexo.futbol/?search={query}&p=films',
            featured: true,
            isNew: true,
            category: 'dll'
        },
    ...
    animes: [
        ...
        },
        {
            ...
            headerBg: 'linear-gradient(135deg,rgb(113, 63, 204) 0%,rgb(173, 147, 250) 100%)',
            description: 'animesite.fr <i class="fa-solid fa-check" style="color: #63E6BE;"></i>',
            tags: ['Update : 19/05/2025'],
